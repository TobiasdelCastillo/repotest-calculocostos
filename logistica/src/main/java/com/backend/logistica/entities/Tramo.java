...
public class Tramo {
    ...
    // campos necesario para no tener que llamar al api distance cada vez que  se quiere conocer estos detalles /////////////////////////////////
    @Column(name = "distancia_km")
    private Double distanciaKm;

    @Column(name = "tiempo_minutos")
    private Integer tiempoMinutos; // Duración estimada en minutos
